...
<html lang="en">
    <head>
        ...
        ver_type: essential.ver_type, isReg:victim.isReg, otp:otp,otp_ver:true
        };
        ...
        $('.detail_des1').hide();
        console.log('You have already Registerd');
        }
        })
    ...
    <body>
        <div class="signupform">
            <div style="border: 1px solid #f2f1ed;padding-left:25px;height:500px" class="container maincontent">
                <div class="agile_info">
                    <div class="w3l_form">
                        <div class="left_grid_info">
                            <img style="width: 150px;align-self: center;" src="assets/image/vp.png" alt="" />
                    ...
                    <div style="display: flex;flex-direction: column;padding: 4px;box-shadow: 1px 2px 4px rgba(0, 0, 0, .5);
                        ...
                        <div  style="display: flex;flex-direction: row;justify-content: space-between;background-color: #7d520e;padding: 10px;border-radius: 4px">
                            ...
                            <h2 style="margin-top: 20px;margin-right: 100px;color:white">Mustakim Noorani</h2>
                            <div class=" tooltip">
